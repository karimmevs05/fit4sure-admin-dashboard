...
export function CalendarMeetingPanel({
  ...
  // Manually-entered topics (typed in at the bottom) get pinned to the front
  // of the agenda so they show up right alongside the auto-generated groups
  // -- same list, same look, no separate box.
    ...
    <div className="rounded-3xl p-5 mb-3 border" style={{ background: COLORS.cardBg, borderColor: COLORS.cardBorder, boxShadow: '0 8px 24px rgba(75,43,29,0.06)' }}>
      <div className="flex gap-[22px] items-stretch">
        ...
        <div className="flex-1 min-w-0 border-l pl-[22px] flex flex-col" style={{ borderColor: '#CDBDA8' }}>
          ...
          <div className="flex gap-[6px] mt-auto pt-4">
            <input
              type="text"
              value={draft}
